    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <p>Equipe 1 : {props.paris.match.equipe1}</p>
                <p>Equipe 2 : {props.paris.match.equipe1}</p>
                <p>Sport : {props.paris.match.sport}</p>
                
                <h1>Informations du stade : {props.paris.stade.nom}</h1>
                <p>Situé à {props.paris.lieu.adresse}</p>
